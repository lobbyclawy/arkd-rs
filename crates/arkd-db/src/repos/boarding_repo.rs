//! Boarding repository — SQLite implementation of `arkd_core::ports::BoardingRepository`

use arkd_core::domain::BoardingTransaction;
use arkd_core::error::{ArkError, ArkResult};
use arkd_core::ports::BoardingRepository;
...
impl BoardingRow {
    fn try_into_boarding_tx(self) -> Option<BoardingTransaction> {
        use arkd_core::domain::BoardingStatus;
