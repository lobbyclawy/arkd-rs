//! Checkpoint repository — SQLite implementation of `arkd_core::ports::CheckpointRepository`

use arkd_core::domain::CheckpointTx;
use arkd_core::error::{ArkError, ArkResult};
use arkd_core::ports::CheckpointRepository;
